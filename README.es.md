...
[![Versión](https://img.shields.io/badge/versi%C3%B3n-2.11.4-79a7ff)](https://github.com/AtlasPCSupport/TabNotes/releases/tag/v2.11.4)
...
| Paquete ZIP            | [`tabnotes-extension-v2.11.4.zip`](https://github.com/AtlasPCSupport/TabNotes/releases/download/v2.11.4/tabnotes-extension-v2.11.4.zip) |
| Sitio del producto     | `https://tabnotes.atlaspcsupport.com/`                                                                                                     |
...
1. Descarga [`tabnotes-extension-v2.11.4.zip`](https://github.com/AtlasPCSupport/TabNotes/releases/download/v2.11.4/tabnotes-extension-v2.11.4.zip).
